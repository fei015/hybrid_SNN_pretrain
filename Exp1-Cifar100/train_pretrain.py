...
def eval_training_H(epoch, args):
    ...
    if args.local_rank == 0:
        # add information to tensorboard
        writer.add_scalar('Test/Average loss_Htanh', test_loss * args.b / len(CIFAR_test_loader.dataset), epoch)
...
if __name__ == '__main__':
    ...
    ImageNet_training_loader = get_training_dataloader(
        traindir="/home/fxf/Code/SNN-ANN-Pretrain/data/imagenet/train",
        num_workers=4,
    ...
    ImageNet_test_loader = get_test_dataloader(
        valdir="/home/fxf/Code/SNN-ANN-Pretrain/data/imagenet/val_sub",
        num_workers=4,
        batch_size=args.b//num_gpus,
        shuffle=False,
        sampler=1
    ...
    '''
    CIFAR_training_loader = get_training_dataloader_CIFAR(sampler=1, batch_size=args.b//num_gpus, num_workers=4, shuffle=False)

    CIFAR_test_loader = get_test_dataloader_CIFAR(sampler=1, batch_size=args.b//num_gpus, num_workers=4, shuffle=False)
