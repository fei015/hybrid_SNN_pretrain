...
def get_training_dataloader_CIFAR(mean=(0.4914, 0.4822, 0.4465), std=(0.2023, 0.1994, 0.2010), sampler=None,batch_size=16, num_workers=2, shuffle=True):
...
def get_test_dataloader_CIFAR(mean=(0.4914, 0.4822, 0.4465), std=(0.2023, 0.1994, 0.2010), sampler=None, batch_size=16, num_workers=2, shuffle=True):
    """ return training dataloader
    Args:
